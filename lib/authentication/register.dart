...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  {
    // allow rider to upload image from gallery
  ...
  getCurrentLocation() async
  {
    Position newPosition = await Geolocator.getCurrentPosition(
      // to get exact location of cafe/restaurant of rider
      // use bestForNavigation for buyer's place since rider traveling there
    ...
    else
      {
        ...
        if(passwordController.text == confirmPasswordController.text) {
          ...
          locationController.text.isNotEmpty) {
            ...
            // access the firebase storage in the riders folder
            fStorage.Reference reference = fStorage.FirebaseStorage.instance.ref().child("riders")
            .child(fileName);
            // upload the file
  ...
  {
    // sets the users' data by id in the riders folder in Firestore
